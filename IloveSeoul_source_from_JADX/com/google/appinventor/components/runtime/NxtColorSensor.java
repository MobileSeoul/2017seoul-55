...
public class NxtColorSensor extends LegoMindstormsNxtSensor implements Deleteable {
    ...
    private int previousColor = Component.COLOR_NONE;
    private State previousState = State.UNKNOWN;
    private final Runnable sensorReader = new C00701();
    ...
    static {
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_RED), Integer.valueOf(14));
        ...
        mapColorToSensorType.put(Integer.valueOf(Component.COLOR_NONE), Integer.valueOf(17));
        ...
        mapSensorValueToColor.put(Integer.valueOf(4), Integer.valueOf(Component.COLOR_YELLOW));
        mapSensorValueToColor.put(Integer.valueOf(5), Integer.valueOf(Component.COLOR_RED));
