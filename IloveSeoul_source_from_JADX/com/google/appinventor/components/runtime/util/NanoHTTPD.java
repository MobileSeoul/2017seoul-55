...
public class NanoHTTPD {
    ...
    public NanoHTTPD(int port, File wwwroot) throws IOException {
        ...
        this.myThread = new Thread(new C01541());
                        ...
                        for (int i = 0; i < files.length; i++) {
                            ...
                            if (curFile.isFile()) {
                                ...
                                if (len < 1024) {
                                    ...
                                    msg = msg + (len / 1024) + "." + (((len % 1024) / 10) % 100) + " KB";
                                } else {
                ...
                if (res != null) {
                    ...
                    try {
                        ...
                        if (range != null || startFrom < 0) {
                            ...
                            InputStream c01552 = new FileInputStream(f) {
                                public int available() throws IOException {
                                    return (int) dataLen;
                                }
                            };
                            c01552.skip(startFrom);
                            response2 = new Response(HTTP_PARTIALCONTENT, mime, c01552);
