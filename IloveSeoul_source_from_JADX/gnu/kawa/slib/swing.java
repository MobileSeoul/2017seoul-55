...
public class swing extends ModuleBody {
    ...
    static {
        ...
        make$Mnaction$Mnlistener = new ModuleMethod(moduleBody, 1, Lit13, 4097);
        fill = new ModuleMethod(moduleBody, 2, Lit14, 4097);
        draw = new ModuleMethod(moduleBody, 3, Lit15, 4097);
        ...
        rotation = new ModuleMethod(moduleBody, 10, Lit20, 4097);
