...
public class testing extends ModuleBody {
    ...
    public class frame1 extends ModuleBody {
        ...
        Object lambda9() {
            return ((Procedure) testing.test$Mnrunner$Mncurrent).apply1(this.f89r);
        }
    ...
    public class frame2 extends ModuleBody {
        ...
        boolean lambda12(Object runner) {
            this.f90i = AddOp.$Pl.apply2(this.f90i, testing.Lit13);
            Object apply2 = Scheme.numGEq.apply2(this.f90i, this.f91n);
            try {
                boolean x = ((Boolean) apply2).booleanValue();
                return x ? ((Boolean) Scheme.numLss.apply2(this.f90i, AddOp.$Pl.apply2(this.f91n, this.count))).booleanValue() : x;
            } catch (ClassCastException e) {
                throw new WrongType(e, "x", -2, apply2);
            }
        }
    ...
    public class frame4 extends ModuleBody {
        ...
        public frame4() {
            PropertySet moduleMethod = new ModuleMethod(this, 10, null, 4097);
    ...
    static {
        ...
        test$Mnrunner$Qu = new ModuleMethod(moduleBody, 12, Lit20, 4097);
        test$Mnrunner$Mnpass$Mncount = new ModuleMethod(moduleBody, 13, Lit21, 4097);
        test$Mnrunner$Mnpass$Mncount$Ex = new ModuleMethod(moduleBody, 14, Lit22, 8194);
        test$Mnrunner$Mnfail$Mncount = new ModuleMethod(moduleBody, 15, Lit23, 4097);
        test$Mnrunner$Mnfail$Mncount$Ex = new ModuleMethod(moduleBody, 16, Lit24, 8194);
        test$Mnrunner$Mnxpass$Mncount = new ModuleMethod(moduleBody, 17, Lit25, 4097);
        test$Mnrunner$Mnxpass$Mncount$Ex = new ModuleMethod(moduleBody, 18, Lit26, 8194);
        test$Mnrunner$Mnxfail$Mncount = new ModuleMethod(moduleBody, 19, Lit27, 4097);
        test$Mnrunner$Mnxfail$Mncount$Ex = new ModuleMethod(moduleBody, 20, Lit28, 8194);
        test$Mnrunner$Mnskip$Mncount = new ModuleMethod(moduleBody, 21, Lit29, 4097);
        test$Mnrunner$Mnskip$Mncount$Ex = new ModuleMethod(moduleBody, 22, Lit30, 8194);
        $Prvt$$Pctest$Mnrunner$Mnskip$Mnlist = new ModuleMethod(moduleBody, 23, Lit31, 4097);
        $Prvt$$Pctest$Mnrunner$Mnskip$Mnlist$Ex = new ModuleMethod(moduleBody, 24, Lit32, 8194);
        $Prvt$$Pctest$Mnrunner$Mnfail$Mnlist = new ModuleMethod(moduleBody, 25, Lit33, 4097);
        $Prvt$$Pctest$Mnrunner$Mnfail$Mnlist$Ex = new ModuleMethod(moduleBody, 26, Lit34, 8194);
        test$Mnrunner$Mngroup$Mnstack = new ModuleMethod(moduleBody, 27, Lit35, 4097);
        test$Mnrunner$Mngroup$Mnstack$Ex = new ModuleMethod(moduleBody, 28, Lit36, 8194);
        test$Mnrunner$Mnon$Mntest$Mnbegin = new ModuleMethod(moduleBody, 29, Lit37, 4097);
        test$Mnrunner$Mnon$Mntest$Mnbegin$Ex = new ModuleMethod(moduleBody, 30, Lit38, 8194);
        test$Mnrunner$Mnon$Mntest$Mnend = new ModuleMethod(moduleBody, 31, Lit39, 4097);
        test$Mnrunner$Mnon$Mntest$Mnend$Ex = new ModuleMethod(moduleBody, 32, Lit40, 8194);
        test$Mnrunner$Mnon$Mngroup$Mnbegin = new ModuleMethod(moduleBody, 33, Lit41, 4097);
        test$Mnrunner$Mnon$Mngroup$Mnbegin$Ex = new ModuleMethod(moduleBody, 34, Lit42, 8194);
        test$Mnrunner$Mnon$Mngroup$Mnend = new ModuleMethod(moduleBody, 35, Lit43, 4097);
        test$Mnrunner$Mnon$Mngroup$Mnend$Ex = new ModuleMethod(moduleBody, 36, Lit44, 8194);
        test$Mnrunner$Mnon$Mnfinal = new ModuleMethod(moduleBody, 37, Lit45, 4097);
        test$Mnrunner$Mnon$Mnfinal$Ex = new ModuleMethod(moduleBody, 38, Lit46, 8194);
        test$Mnrunner$Mnon$Mnbad$Mncount = new ModuleMethod(moduleBody, 39, Lit47, 4097);
        test$Mnrunner$Mnon$Mnbad$Mncount$Ex = new ModuleMethod(moduleBody, 40, Lit48, 8194);
        test$Mnrunner$Mnon$Mnbad$Mnend$Mnname = new ModuleMethod(moduleBody, 41, Lit49, 4097);
        test$Mnrunner$Mnon$Mnbad$Mnend$Mnname$Ex = new ModuleMethod(moduleBody, 42, Lit50, 8194);
        test$Mnresult$Mnalist = new ModuleMethod(moduleBody, 43, Lit51, 4097);
        test$Mnresult$Mnalist$Ex = new ModuleMethod(moduleBody, 44, Lit52, 8194);
        test$Mnrunner$Mnaux$Mnvalue = new ModuleMethod(moduleBody, 45, Lit53, 4097);
        test$Mnrunner$Mnaux$Mnvalue$Ex = new ModuleMethod(moduleBody, 46, Lit54, 8194);
        test$Mnrunner$Mnreset = new ModuleMethod(moduleBody, 47, Lit55, 4097);
        test$Mnrunner$Mngroup$Mnpath = new ModuleMethod(moduleBody, 48, Lit56, 4097);
        $Pctest$Mnnull$Mncallback = new ModuleMethod(moduleBody, 49, Lit57, 4097);
        ...
        $Prvt$$Pctest$Mnshould$Mnexecute = new ModuleMethod(moduleBody, 57, Lit62, 4097);
        ...
        test$Mnon$Mngroup$Mnend$Mnsimple = new ModuleMethod(moduleBody, 60, Lit65, 4097);
        ...
        test$Mnon$Mnfinal$Mnsimple = new ModuleMethod(moduleBody, 63, Lit68, 4097);
        $Prvt$$Pctest$Mnend = new ModuleMethod(moduleBody, 64, Lit69, 8194);
        test$Mnon$Mntest$Mnbegin$Mnsimple = new ModuleMethod(moduleBody, 65, Lit74, 4097);
        test$Mnon$Mntest$Mnend$Mnsimple = new ModuleMethod(moduleBody, 66, Lit77, 4097);
        test$Mnresult$Mnset$Ex = new ModuleMethod(moduleBody, 67, Lit78, 12291);
        test$Mnresult$Mnclear = new ModuleMethod(moduleBody, 68, Lit79, 4097);
        ...
        $Prvt$$Pctest$Mnon$Mntest$Mnbegin = new ModuleMethod(moduleBody, 73, Lit86, 4097);
        $Prvt$$Pctest$Mnon$Mntest$Mnend = new ModuleMethod(moduleBody, 74, Lit87, 8194);
        test$Mnrunner$Mntest$Mnname = new ModuleMethod(moduleBody, 75, Lit88, 4097);
        $Prvt$$Pctest$Mnapproximimate$Eq = new ModuleMethod(moduleBody, 76, Lit91, 4097);
        simpleSymbol = Lit94;
        PropertySet moduleMethod2 = new ModuleMethod(moduleBody, 77, null, 4097);
        ...
        simpleSymbol = Lit99;
        moduleMethod2 = new ModuleMethod(moduleBody, 78, null, 4097);
        ...
        simpleSymbol = Lit108;
        moduleMethod2 = new ModuleMethod(moduleBody, 81, null, 4097);
        ...
        simpleSymbol = Lit110;
        moduleMethod2 = new ModuleMethod(moduleBody, 82, null, 4097);
        ...
        simpleSymbol = Lit117;
        moduleMethod2 = new ModuleMethod(moduleBody, 83, null, 4097);
        ...
        $Prvt$$Pctest$Mnas$Mnspecifier = new ModuleMethod(moduleBody, 88, Lit136, 4097);
        test$Mnmatch$Mnname = new ModuleMethod(moduleBody, 89, Lit141, 4097);
        test$Mnread$Mneval$Mnstring = new ModuleMethod(moduleBody, 90, Lit142, 4097);
        $instance.run();
    }
    ...
    public static void testResultRemove(Object runner, Object pname) {
        ...
        try {
            Object alist = testResultAlist((test$Mnrunner) runner);
            gnu_kawa_slib_testing_frame.f92p = lists.assq(pname, alist);
            if (gnu_kawa_slib_testing_frame.f92p != Boolean.FALSE) {
                try {
    ...
    public static Object testApply$V(Object first, Object[] argsArray) {
        ...
        gnu_kawa_slib_testing_frame1.f89r = testRunnerCreate();
        ...
        Object obj = gnu_kawa_slib_testing_frame1.f89r;
        try {
            return procedure.apply2(testRunnerOnFinal((test$Mnrunner) obj), gnu_kawa_slib_testing_frame1.f89r);
    ...
    public static Procedure $PcTestMatchNth(Object n, Object count) {
        ...
        gnu_kawa_slib_testing_frame2.f91n = n;
        gnu_kawa_slib_testing_frame2.count = count;
        gnu_kawa_slib_testing_frame2.f90i = Lit0;
