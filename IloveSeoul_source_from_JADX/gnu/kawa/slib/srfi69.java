...
public class srfi69 extends ModuleBody {
    ...
    static {
        ...
        hash$Mntable$Mnequivalence$Mnfunction = new ModuleMethod(moduleBody, 9, Lit5, 4097);
        hash$Mntable$Mnhash$Mnfunction = new ModuleMethod(moduleBody, 10, Lit6, 4097);
        ...
        PropertySet moduleMethod = new ModuleMethod(moduleBody, 23, null, 4097);
        ...
        hash$Mntable$Mn$Gralist = new ModuleMethod(moduleBody, 28, Lit15, 4097);
        hash$Mntable$Mncopy = new ModuleMethod(moduleBody, 29, Lit16, 4097);
        ...
        hash$Mntable$Mnkeys = new ModuleMethod(moduleBody, 32, Lit18, 4097);
        ...
        hash$Mntable$Mnvalues = new ModuleMethod(moduleBody, 34, Lit19, 4097);
        $instance.run();
    }
