...
public class conditions extends ModuleBody {
    ...
    static {
        ...
        condition$Mntype$Qu = new ModuleMethod(moduleBody, 2, Lit6, 4097);
        make$Mncondition$Mntype = new ModuleMethod(moduleBody, 3, Lit7, 12291);
        condition$Qu = new ModuleMethod(moduleBody, 4, Lit10, 4097);
        ...
        $Prvt$type$Mnfield$Mnalist$Mn$Grcondition = new ModuleMethod(moduleBody, 10, Lit20, 4097);
        $instance.run();
    }
