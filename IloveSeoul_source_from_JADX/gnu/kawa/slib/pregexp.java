                ...
                if (Scheme.isEqv.apply2(gnu_kawa_slib_pregexp_frame0.re$1, pregexp.Lit26) != Boolean.FALSE) {
                    ...
                    if (x ? Scheme.numLss.apply2(gnu_kawa_slib_pregexp_frame0.f8i, this.f16n) != Boolean.FALSE : x) {
                        ...
                        try {
                            ...
                            obj = gnu_kawa_slib_pregexp_frame0.f8i;
                            try {
                                ...
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit20) != Boolean.FALSE) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                return pregexp.pregexpStringMatch(strings.substring(charSequence, intValue, ((Number) obj).intValue()), this.f17s, gnu_kawa_slib_pregexp_frame0.f8i, this.f16n, gnu_kawa_slib_pregexp_frame0.lambda$Fn4, gnu_kawa_slib_pregexp_frame0.fk);
                                                ...
                                                if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, pregexp.Lit61) != Boolean.FALSE : x2 != Boolean.FALSE) {
                                                    ...
                                                    try {
                                                        ...
                                                        if (gnu_kawa_slib_pregexp_frame0.maximal$Qu) {
                                                            obj2 = gnu_kawa_slib_pregexp_frame0.f10q;
                                                            try {
                                                                int i2;
