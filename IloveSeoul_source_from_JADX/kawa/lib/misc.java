...
public class misc extends ModuleBody {
    ...
    static {
        ...
        boolean$Qu = new ModuleMethod(moduleBody, 3, Lit4, 4097);
        symbol$Qu = new ModuleMethod(moduleBody, 4, Lit5, 4097);
        symbol$Mn$Grstring = new ModuleMethod(moduleBody, 5, Lit6, 4097);
        ...
        symbol$Mnlocal$Mnname = new ModuleMethod(moduleBody, 8, Lit7, 4097);
        symbol$Mnnamespace = new ModuleMethod(moduleBody, 9, Lit8, 4097);
        symbol$Mnnamespace$Mnuri = new ModuleMethod(moduleBody, 10, Lit9, 4097);
        symbol$Mnprefix = new ModuleMethod(moduleBody, 11, Lit10, 4097);
        namespace$Mnuri = new ModuleMethod(moduleBody, 12, Lit11, 4097);
        namespace$Mnprefix = new ModuleMethod(moduleBody, 13, Lit12, 4097);
        string$Mn$Grsymbol = new ModuleMethod(moduleBody, 14, Lit13, 4097);
        procedure$Qu = new ModuleMethod(moduleBody, 15, Lit14, 4097);
        ...
        scheme$Mnreport$Mnenvironment = new ModuleMethod(moduleBody, 20, Lit18, 4097);
        ...
        force = new ModuleMethod(moduleBody, 27, Lit24, 4097);
