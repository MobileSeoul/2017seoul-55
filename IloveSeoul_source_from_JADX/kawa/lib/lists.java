...
public class lists extends ModuleBody {
    ...
    static {
        ...
        pair$Qu = new ModuleMethod(moduleBody, 1, Lit3, 4097);
        cons = new ModuleMethod(moduleBody, 2, Lit4, 8194);
        null$Qu = new ModuleMethod(moduleBody, 3, Lit5, 4097);
        set$Mncar$Ex = new ModuleMethod(moduleBody, 4, Lit6, 8194);
        set$Mncdr$Ex = new ModuleMethod(moduleBody, 5, Lit7, 8194);
        PropertySet moduleMethod = new ModuleMethod(moduleBody, 6, "car", 4097);
        ...
        moduleMethod = new ModuleMethod(moduleBody, 7, "cdr", 4097);
        ...
        caar$Fn4 = new ModuleMethod(moduleBody, 9, "caar", 4097);
        lambda$Fn5 = new ModuleMethod(moduleBody, 10, null, 8194);
        cadr$Fn6 = new ModuleMethod(moduleBody, 11, "cadr", 4097);
        lambda$Fn7 = new ModuleMethod(moduleBody, 12, null, 8194);
        cdar$Fn8 = new ModuleMethod(moduleBody, 13, "cdar", 4097);
        lambda$Fn9 = new ModuleMethod(moduleBody, 14, null, 8194);
        cddr$Fn10 = new ModuleMethod(moduleBody, 15, "cddr", 4097);
        lambda$Fn11 = new ModuleMethod(moduleBody, 16, null, 8194);
        caaar$Fn12 = new ModuleMethod(moduleBody, 17, "caaar", 4097);
        lambda$Fn13 = new ModuleMethod(moduleBody, 18, null, 8194);
        caadr$Fn14 = new ModuleMethod(moduleBody, 19, "caadr", 4097);
        lambda$Fn15 = new ModuleMethod(moduleBody, 20, null, 8194);
        cadar$Fn16 = new ModuleMethod(moduleBody, 21, "cadar", 4097);
        lambda$Fn17 = new ModuleMethod(moduleBody, 22, null, 8194);
        caddr$Fn18 = new ModuleMethod(moduleBody, 23, "caddr", 4097);
        lambda$Fn19 = new ModuleMethod(moduleBody, 24, null, 8194);
        cdaar$Fn20 = new ModuleMethod(moduleBody, 25, "cdaar", 4097);
        lambda$Fn21 = new ModuleMethod(moduleBody, 26, null, 8194);
        cdadr$Fn22 = new ModuleMethod(moduleBody, 27, "cdadr", 4097);
        lambda$Fn23 = new ModuleMethod(moduleBody, 28, null, 8194);
        cddar$Fn24 = new ModuleMethod(moduleBody, 29, "cddar", 4097);
        lambda$Fn25 = new ModuleMethod(moduleBody, 30, null, 8194);
        cdddr$Fn26 = new ModuleMethod(moduleBody, 31, "cdddr", 4097);
        lambda$Fn27 = new ModuleMethod(moduleBody, 32, null, 8194);
        caaaar$Fn28 = new ModuleMethod(moduleBody, 33, "caaaar", 4097);
        lambda$Fn29 = new ModuleMethod(moduleBody, 34, null, 8194);
        caaadr$Fn30 = new ModuleMethod(moduleBody, 35, "caaadr", 4097);
        lambda$Fn31 = new ModuleMethod(moduleBody, 36, null, 8194);
        caadar$Fn32 = new ModuleMethod(moduleBody, 37, "caadar", 4097);
        lambda$Fn33 = new ModuleMethod(moduleBody, 38, null, 8194);
        caaddr$Fn34 = new ModuleMethod(moduleBody, 39, "caaddr", 4097);
        lambda$Fn35 = new ModuleMethod(moduleBody, 40, null, 8194);
        cadaar$Fn36 = new ModuleMethod(moduleBody, 41, "cadaar", 4097);
        lambda$Fn37 = new ModuleMethod(moduleBody, 42, null, 8194);
        cadadr$Fn38 = new ModuleMethod(moduleBody, 43, "cadadr", 4097);
        lambda$Fn39 = new ModuleMethod(moduleBody, 44, null, 8194);
        caddar$Fn40 = new ModuleMethod(moduleBody, 45, "caddar", 4097);
        lambda$Fn41 = new ModuleMethod(moduleBody, 46, null, 8194);
        cadddr$Fn42 = new ModuleMethod(moduleBody, 47, "cadddr", 4097);
        lambda$Fn43 = new ModuleMethod(moduleBody, 48, null, 8194);
        cdaaar$Fn44 = new ModuleMethod(moduleBody, 49, "cdaaar", 4097);
        lambda$Fn45 = new ModuleMethod(moduleBody, 50, null, 8194);
        cdaadr$Fn46 = new ModuleMethod(moduleBody, 51, "cdaadr", 4097);
        lambda$Fn47 = new ModuleMethod(moduleBody, 52, null, 8194);
        cdadar$Fn48 = new ModuleMethod(moduleBody, 53, "cdadar", 4097);
        lambda$Fn49 = new ModuleMethod(moduleBody, 54, null, 8194);
        cdaddr$Fn50 = new ModuleMethod(moduleBody, 55, "cdaddr", 4097);
        lambda$Fn51 = new ModuleMethod(moduleBody, 56, null, 8194);
        cddaar$Fn52 = new ModuleMethod(moduleBody, 57, "cddaar", 4097);
        lambda$Fn53 = new ModuleMethod(moduleBody, 58, null, 8194);
        cddadr$Fn54 = new ModuleMethod(moduleBody, 59, "cddadr", 4097);
        lambda$Fn55 = new ModuleMethod(moduleBody, 60, null, 8194);
        cdddar$Fn56 = new ModuleMethod(moduleBody, 61, "cdddar", 4097);
        lambda$Fn57 = new ModuleMethod(moduleBody, 62, null, 8194);
        cddddr$Fn58 = new ModuleMethod(moduleBody, 63, "cddddr", 4097);
        length = new ModuleMethod(moduleBody, 64, Lit8, 4097);
        reverse = new ModuleMethod(moduleBody, 65, Lit9, 4097);
        list$Mntail = new ModuleMethod(moduleBody, 66, Lit10, 8194);
        list$Mnref = new ModuleMethod(moduleBody, 67, Lit11, 8194);
        list$Qu = new ModuleMethod(moduleBody, 68, Lit12, 4097);
        reverse$Ex = new ModuleMethod(moduleBody, 69, Lit13, 4097);
