...
public class numbers extends ModuleBody {
    ...
    static {
        ...
        number$Qu = new ModuleMethod(moduleBody, 1, Lit3, 4097);
        quantity$Qu = new ModuleMethod(moduleBody, 2, Lit4, 4097);
        complex$Qu = new ModuleMethod(moduleBody, 3, Lit5, 4097);
        real$Qu = new ModuleMethod(moduleBody, 4, Lit6, 4097);
        rational$Qu = new ModuleMethod(moduleBody, 5, Lit7, 4097);
        integer$Qu = new ModuleMethod(moduleBody, 6, Lit8, 4097);
        exact$Qu = new ModuleMethod(moduleBody, 7, Lit9, 4097);
        inexact$Qu = new ModuleMethod(moduleBody, 8, Lit10, 4097);
        zero$Qu = new ModuleMethod(moduleBody, 9, Lit11, 4097);
        positive$Qu = new ModuleMethod(moduleBody, 10, Lit12, 4097);
        negative$Qu = new ModuleMethod(moduleBody, 11, Lit13, 4097);
        max = new ModuleMethod(moduleBody, 12, Lit14, -4096);
        min = new ModuleMethod(moduleBody, 13, Lit15, -4096);
        abs = new ModuleMethod(moduleBody, 14, Lit16, 4097);
        ...
        numerator = new ModuleMethod(moduleBody, 19, Lit21, 4097);
        denominator = new ModuleMethod(moduleBody, 20, Lit22, 4097);
        floor = new ModuleMethod(moduleBody, 21, Lit23, 4097);
        ceiling = new ModuleMethod(moduleBody, 22, Lit24, 4097);
        truncate = new ModuleMethod(moduleBody, 23, Lit25, 4097);
        round = new ModuleMethod(moduleBody, 24, Lit26, 4097);
        rationalize = new ModuleMethod(moduleBody, 25, Lit27, 8194);
        exp = new ModuleMethod(moduleBody, 26, Lit28, 4097);
        log = new ModuleMethod(moduleBody, 27, Lit29, 4097);
        sin = new ModuleMethod(moduleBody, 28, Lit30, 4097);
        cos = new ModuleMethod(moduleBody, 29, Lit31, 4097);
        tan = new ModuleMethod(moduleBody, 30, Lit32, 4097);
        asin = new ModuleMethod(moduleBody, 31, Lit33, 4097);
        acos = new ModuleMethod(moduleBody, 32, Lit34, 4097);
        ...
        moduleMethod = new ModuleMethod(moduleBody, 34, null, 4097);
        ...
        moduleMethod = new ModuleMethod(moduleBody, 35, null, 4097);
        ...
        moduleMethod = new ModuleMethod(moduleBody, 36, null, 4097);
        ...
        real$Mnpart = new ModuleMethod(moduleBody, 39, Lit37, 4097);
        imag$Mnpart = new ModuleMethod(moduleBody, 40, Lit38, 4097);
        magnitude = new ModuleMethod(moduleBody, 41, Lit39, 4097);
        angle = new ModuleMethod(moduleBody, 42, Lit40, 4097);
        inexact = new ModuleMethod(moduleBody, 43, Lit41, 4097);
        exact = new ModuleMethod(moduleBody, 44, Lit42, 4097);
        exact$Mn$Grinexact = new ModuleMethod(moduleBody, 45, Lit43, 4097);
        inexact$Mn$Grexact = new ModuleMethod(moduleBody, 46, Lit44, 4097);
        ...
        logcount = new ModuleMethod(moduleBody, 54, Lit52, 4097);
        bitwise$Mnbit$Mncount = new ModuleMethod(moduleBody, 55, Lit53, 4097);
        bitwise$Mnlength = new ModuleMethod(moduleBody, 56, Lit54, 4097);
        bitwise$Mnfirst$Mnbit$Mnset = new ModuleMethod(moduleBody, 57, Lit55, 4097);
        ...
        quantity$Mn$Grnumber = new ModuleMethod(moduleBody, 64, Lit60, 4097);
        quantity$Mn$Grunit = new ModuleMethod(moduleBody, 65, Lit61, 4097);
        make$Mnquantity = new ModuleMethod(moduleBody, 66, Lit62, 8194);
        duration = new ModuleMethod(moduleBody, 67, Lit63, 4097);
        $instance.run();
    }
