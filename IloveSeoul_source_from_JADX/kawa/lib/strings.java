...
public class strings extends ModuleBody {
    ...
    static {
        ...
        string$Qu = new ModuleMethod(moduleBody, 1, Lit1, 4097);
        make$Mnstring = new ModuleMethod(moduleBody, 2, Lit2, 8193);
        $make$string$ = new ModuleMethod(moduleBody, 4, Lit3, -4096);
        string$Mnlength = new ModuleMethod(moduleBody, 5, Lit4, 4097);
        ...
        string$Mn$Grlist = new ModuleMethod(moduleBody, 14, Lit13, 4097);
        list$Mn$Grstring = new ModuleMethod(moduleBody, 15, Lit14, 4097);
        string$Mncopy = new ModuleMethod(moduleBody, 16, Lit15, 4097);
        string$Mnfill$Ex = new ModuleMethod(moduleBody, 17, Lit16, 8194);
        string$Mnupcase$Ex = new ModuleMethod(moduleBody, 18, Lit17, 4097);
        string$Mndowncase$Ex = new ModuleMethod(moduleBody, 19, Lit18, 4097);
        string$Mncapitalize$Ex = new ModuleMethod(moduleBody, 20, Lit19, 4097);
        string$Mncapitalize = new ModuleMethod(moduleBody, 21, Lit20, 4097);
