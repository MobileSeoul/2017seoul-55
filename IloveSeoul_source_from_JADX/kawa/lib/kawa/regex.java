...
public class regex extends ModuleBody {
    ...
    static {
        ...
        regex$Mnquote = new ModuleMethod(moduleBody, 2, Lit1, 4097);
        regex$Mnmatch$Qu = new ModuleMethod(moduleBody, 3, Lit2, 16386);
        regex$Mnmatch = new ModuleMethod(moduleBody, 6, Lit3, 16386);
        regex$Mnmatch$Mnpositions = new ModuleMethod(moduleBody, 9, Lit4, 16386);
