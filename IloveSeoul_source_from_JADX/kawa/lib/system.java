...
public class system extends ModuleBody {
    ...
    public static final ModuleMethod f100catch;
    ...
    static {
        ...
        open$Mninput$Mnpipe = new ModuleMethod(moduleBody, 2, Lit3, 4097);
        system = new ModuleMethod(moduleBody, 3, Lit4, 4097);
        convert$Mnvector$Mnto$Mnstring$Mnarray = new ModuleMethod(moduleBody, 4, Lit5, 4097);
        convert$Mnlist$Mnto$Mnstring$Mnarray = new ModuleMethod(moduleBody, 5, Lit6, 4097);
        tokenize$Mnstring$Mnto$Mnstring$Mnarray = new ModuleMethod(moduleBody, 6, Lit7, 4097);
        tokenize$Mnstring$Mnusing$Mnshell = new ModuleMethod(moduleBody, 7, Lit8, 4097);
        compile$Mnfile = new ModuleMethod(moduleBody, 8, Lit9, 8194);
        f100catch = new ModuleMethod(moduleBody, 9, Lit10, 12291);
    ...
    public static Object m29catch(Object key, Procedure thunk, Procedure handler) {
        try {
            return thunk.apply0();
    ...
    public Object apply3(ModuleMethod moduleMethod, Object obj, Object obj2, Object obj3) {
        ...
        try {
            try {
                return m29catch(obj, (Procedure) obj2, (Procedure) obj3);
            } catch (ClassCastException e) {
